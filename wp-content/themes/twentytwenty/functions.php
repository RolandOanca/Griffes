...
function load_stylesheets()
{
    ...
    // wp_register_style('style', get_template_directory_uri() . '/style.css', array(), microtime(), false, 'all');
...
function loadjs()
{
    ...
    wp_register_script('scrolljs', '//cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.js', '' , 1, true);
    wp_enqueue_script('scrolljs');

    wp_register_script('customjs',  get_template_directory_uri() . '/js/scripts.js', '' , microtime(), true);
